...
document.body.addEventListener("click", function(e) {
	...
	else if(targetId == "forgot-password") {
		changeCard(firstCard, forgotPasswordSection);
	}
	else if(targetId == "reset-password") {
		reset()
	}
});
...
function reset() {
	...
	let resetXhr = new XMLHttpRequest();
	resetXhr.open("GET", `/reset/${resetEmail}`, true);
	resetXhr.send();
